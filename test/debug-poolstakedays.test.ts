...
describe('DEBUG: poolStakeDays Analysis', function () {
  ...
  it('Analyze poolStakeDays accumulation', async function () {
    ...
    console.log(`  Pool0 and Pool1 are EMPTY → empty pool redistribution applies`);
    ...
    console.log(`  Pool2 received: ${ethers.formatEther(reward1)} ANON (100% due to empty pool redistribution)`);
    ...
    console.log(`  Pool2 received: ${ethers.formatEther(reward2)} ANON (100% due to empty pool redistribution)`);
    ...
    console.log(`Period 1: ${days1} days * 100 tokens * ${snap1[1]} / 1e18 = ${aliceReward1}`);

    const aliceReward2 = (100n * BigInt(days2) * snap2[1]) / 10n ** 18n;
    console.log(`Period 2: ${days2} days * 100 tokens * ${snap2[1]} / 1e18 = ${aliceReward2}`);
